...
<body>
  <g:render  template="/headers/header" model="['titulo':message(code:'default.list.label',args:['Chequeras']), 'boton':message(code:'default.new.label.fem',args:['Chequera']), 'accion':'create' ]"/>
  <section id="content">
