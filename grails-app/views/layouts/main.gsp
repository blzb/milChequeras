...
<html lang="en">
  <head>
    ...
    <!-- color picker -->
    <link rel="stylesheet" href="flattern/colorpicker/css/colorpicker.css" type="text/css" />
    <!-- boxed bg -->
    ...
    <link href="${resource(dir: 'flattern/css', file: 'bootstrap-datetimepicker.min.css')}" rel="stylesheet" />
    ...
    <script src="${resource(dir: 'flattern/js', file: 'bootstrap-datetimepicker.min.js')}"></script>
    ...
    <header>			
      <div class="container-fluid">        
        ...
        <div class="row-fluid nomargin">
          <div class="span4">
            <div class="logo">
              <g:link uri="/" class="home" ><img src="${resource(dir: 'flattern/img', file: 'logo.png')}" alt="" class="logo" style="width: 50%;"/></g:link>
            </div>
          </div>
          <div class="span8">
