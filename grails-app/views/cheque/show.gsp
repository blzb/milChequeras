        ...
        <div id="show-cheque" class="content scaffold-show " role="main">
          ...
          <div class="span12 well"> 
            ...
            <ol class="property-list cheque">
              ...
              <g:if test="${chequeInstance?.texto}">
                <li class="fieldcontain">
                  <span id="texto-label" class="property-label"><g:message code="cheque.texto.label" default="Texto" /></span>
  
                <span class="property-value" aria-labelledby="texto-label"><g:fieldValue bean="${chequeInstance}" field="texto"/></span>
