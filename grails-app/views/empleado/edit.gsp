          ...
          <div class="span12 well">  
            ...
            <g:form url="[resource:empleadoInstance, action:'update']" method="PUT" >
              ...
              <fieldset class="buttons">
                <g:actionSubmit class="save btn btn-large btn-theme btn-rounded" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" /><g:link controller="tienda" action="edit" id="${empleadoInstance.tienda.id}" class="btn btn-large btn-theme btn-rounded">Cancelar</g:link>
              </fieldset>
            </g:form>
          </div>
        </div>
